lab_content = {
			...
			'cogsci': {
                ...
                "overview": {
                    ...
                    "text": """
                        ...
                        Last year, our lab worked on projects involving neural atrophication, language processing, consciousness and decision-making, but we are currently developing exciting research projects for the upcoming school year. </br> </br>
			...
			'health': {
				...
				"join": {
				    "title": "Want to join us?",
				    "text": u"""
				            Unfortunately, applications are currently unavailable.  More details will be posted at a later date. Sorry for the inconvenience!
				            """
				},
				"calendar": {
				    "title": "",
